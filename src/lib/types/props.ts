import type { AriaAttributes, ButtonHTMLAttributes, ReactNode, RefObject } from 'react';
...
export interface SortableListItemRemoveProps extends ButtonHTMLAttributes<HTMLButtonElement> {
	/** Content to be rendered inside the handle. */
	children?: ReactNode;
}
